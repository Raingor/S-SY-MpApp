...
Object.assign(messages['zh-CN'], {
  guideService: '古迹讲解', homeSlogan: '只为一生美好回忆', homeHeroSlogan: '希伴旅 · 只为一生美好回忆', homeGuideCta: '查看档案 / 预约时间', selectedRoutes: '甄选路线', viewAllRoutes: '查看全部参考行程', viewReference: '查看参考行程', customItinerary: '定制行程 · 填写需求，获取专属方案', customItineraryDesc: '以上路线仅作参考，告诉我们你的日期、人数与偏好，顾问一对一为你定制专属行程', luxury: '奢享体验', luxuryTag: '高端定制', luxuryCta: '定制咨询', destinations: '精选目的地', destinationCategoryEmpty: '该分类暂无可展示的目的地', civilization: '文明溯源', islands: '海岛度假', routeAudio: { kicker: 'ROUTE AUDIO', title: '甄选路线语音导览', desc: '先听一段路线故事，再开始挑选你的旅程。', name: '甄选路线语音导览', author: '希腊旅行管家', preview: '免费试听 1 分钟 · 播放到 1:00 自动停止', ended: '试听已结束（1 分钟）', play: '播放', pause: '暂停', restart: '重头播放', error: '音频暂时无法播放，请检查网络后重试' }
});
Object.assign(messages['zh-TW'], {
  guideService: '古蹟講解', homeSlogan: '只為一生美好回憶', homeHeroSlogan: '希伴旅 · 只為一生美好回憶', homeGuideCta: '查看檔案 / 預約時間', selectedRoutes: '精選路線', viewAllRoutes: '查看全部參考行程', viewReference: '查看參考行程', customItinerary: '定製行程 · 填寫需求，獲取專屬方案', customItineraryDesc: '以上路線僅作參考，告訴我們你的日期、人數與偏好，顧問一對一為你定製專屬行程', luxury: '奢享體驗', luxuryTag: '高端定製', luxuryCta: '定製諮詢', destinations: '精選目的地', destinationCategoryEmpty: '此分類暫無可展示的目的地', civilization: '文明溯源', islands: '海島度假', routeAudio: { kicker: 'ROUTE AUDIO', title: '精選路線語音導覽', desc: '先聽一段路線故事，再開始挑選你的旅程。', name: '精選路線語音導覽', author: '希臘旅行管家', preview: '免費試聽 1 分鐘 · 播放到 1:00 自動停止', ended: '試聽已結束（1 分鐘）', play: '播放', pause: '暫停', restart: '重頭播放', error: '音訊暫時無法播放，請檢查網路後重試' }
});
Object.assign(messages.en, {
  guideService: 'Heritage guide', homeSlogan: 'Only for a lifetime of beautiful memories', homeHeroSlogan: 'Xiban Travel · Only for a lifetime of beautiful memories', homeGuideCta: 'View profile / Reserve time', selectedRoutes: 'Selected routes', viewAllRoutes: 'View all reference trips', viewReference: 'View itinerary', customItinerary: 'Private itinerary · Share your needs for a tailored plan', customItineraryDesc: 'Routes are examples. Tell us your dates, group and preferences for one-to-one planning.', luxury: 'Luxury experiences', luxuryTag: 'Bespoke luxury', luxuryCta: 'Request a plan', destinations: 'Featured destinations', destinationCategoryEmpty: 'No destinations are available in this category yet', civilization: 'Heritage', islands: 'Island escapes', routeAudio: { kicker: 'ROUTE AUDIO', title: 'Selected route audio guide', desc: 'Listen to a route story before choosing your journey.', name: 'Selected route audio guide', author: 'Greece Travel Butler', preview: 'Free 1-minute preview · stops at 1:00', ended: 'Preview ended (1 minute)', play: 'Play', pause: 'Pause', restart: 'Restart', error: 'Audio could not be played. Check your connection and try again.' }
});
Object.assign(messages['zh-CN'], { homeHeroEmpty: '首页内容暂未发布' });
Object.assign(messages['zh-TW'], { homeHeroEmpty: '首頁內容尚未發布' });
Object.assign(messages.en, { homeHeroEmpty: 'No homepage content has been published yet' });
...
messages['zh-CN'].contentPage = { about: '景点概览', highlights: '必看亮点', allHighlights: '查看全部', collapseHighlights: '收起亮点', visitorGuide: '参观指南', deepDive: '深度文史讲解', freePreview: '免费文字预览', paid: '付费解锁内容', locked: '锁定', unlock: '付费解锁（功能开发中）', consultTitle: '想把景点读得更深？', consultDesc: '预约一对一线上人文咨询，先聊聊你的目的地。', cityAbout: '了解「希腊旅行管家」导览讲解的不同之处', cityInside: '专业编写的图文与语音讲解，按景点逐层展开：先看必看亮点，再看参观指南，最后深入历史、神话与建筑。', buy: '购买导览包', viewSpots: '先看景点', freeBrowse: '免费浏览', buySpots: '购买', priceUnavailable: '价格待后台配置', destinationEmpty: '暂未找到该目的地', destinationEmptyDesc: '该城市可能已停用，或暂时没有可展示的内容。', spotsEmpty: '暂无可展示的景点', spotsEmptyDesc: '该城市暂时没有有效关联的景点，请返回精选目的地。', attractionEmpty: '暂未找到该景点', attractionEmptyDesc: '景点链接可能已失效或内容已下线，请返回精选目的地。', backToDestinations: '返回精选目的地', itineraryPeriod: '行程日期', itineraryNumber: '订单编号', visitors: '旅客人数', preferredLanguages: '语种需求', plannedVehicle: '计划车型', privateGuide: '推荐司导', invalidItinerary: '未找到该行程', invalidLink: '行程链接无效或已失效' };
messages['zh-TW'].contentPage = { about: '景點概覽', highlights: '必看亮點', allHighlights: '查看全部', collapseHighlights: '收起亮點', visitorGuide: '參觀指南', deepDive: '深度文史講解', freePreview: '免費文字預覽', paid: '付費解鎖內容', locked: '鎖定', unlock: '付費解鎖（功能開發中）', consultTitle: '想把景點讀得更深？', consultDesc: '預約一對一線上人文諮詢，先聊聊你的目的地。', cityAbout: '了解「希臘旅行管家」導覽講解的不同之處', cityInside: '專業編寫的圖文與語音講解，按景點逐層展開：先看必看亮點，再看參觀指南，最後深入歷史、神話與建築。', buy: '購買導覽包', viewSpots: '先看景點', freeBrowse: '免費瀏覽', buySpots: '購買', priceUnavailable: '價格待後台配置', destinationEmpty: '暫未找到此目的地', destinationEmptyDesc: '此城市可能已停用，或暫時沒有可展示的內容。', spotsEmpty: '暫無可展示的景點', spotsEmptyDesc: '此城市暫時沒有有效關聯的景點，請返回精選目的地。', attractionEmpty: '暫未找到此景點', attractionEmptyDesc: '景點連結可能已失效或內容已下線，請返回精選目的地。', backToDestinations: '返回精選目的地', itineraryPeriod: '行程日期', itineraryNumber: '訂單編號', visitors: '旅客人數', preferredLanguages: '語種需求', plannedVehicle: '計劃車型', privateGuide: '推薦司導', invalidItinerary: '未找到該行程', invalidLink: '行程連結無效或已失效' };
messages.en.contentPage = { about: 'Overview', highlights: 'Highlights', allHighlights: 'View all', collapseHighlights: 'Show less', visitorGuide: 'Visitor guide', deepDive: 'History & context', freePreview: 'Free text preview', paid: 'Paid content', locked: 'Locked', unlock: 'Unlock (coming soon)', consultTitle: 'Want to go deeper?', consultDesc: 'Book a one-to-one humanities consultation and start with your destination.', cityAbout: 'What makes Greece Travel Butler guides different', cityInside: 'Professionally written text and audio guides unfold by sight: highlights first, then practical visiting notes, then history, mythology and architecture.', buy: 'Buy guide package', viewSpots: 'Browse sights', freeBrowse: 'Free preview', buySpots: 'Buy', priceUnavailable: 'Price not configured by the backend', destinationEmpty: 'Destination not found', destinationEmptyDesc: 'This city may be inactive or does not have content available right now.', spotsEmpty: 'No sights available', spotsEmptyDesc: 'There are no valid sights associated with this city yet. Return to featured destinations.', attractionEmpty: 'Sight not found', attractionEmptyDesc: 'This sight link may be invalid or the content may be offline. Return to featured destinations.', backToDestinations: 'Back to featured destinations', itineraryPeriod: 'Travel dates', itineraryNumber: 'Itinerary number', visitors: 'Travelers', preferredLanguages: 'Languages', plannedVehicle: 'Vehicle', privateGuide: 'Private guide', invalidItinerary: 'Itinerary not found', invalidLink: 'This itinerary link is invalid or expired' };
...
Object.assign(messages['zh-CN'].guide, {
  services: { title: '古迹讲解，两种方式读懂希腊', offlineTitle: '线下陪同讲解', offlineDesc: '提交意向日期与路线，由顾问确认线下陪同安排。', offlineCta: '填写日期，预约陪同', liveTitle: '线上实时直播', liveDesc: '到达景点后通过手机与顾问实时连线，提交预约后确认安排。', liveCta: '预约线上直播', trialTitle: '名导景点讲解试听', trialDesc: '先免费试听，再进入深度景点讲解。', trialCta: '免费试听更多内容' }
});
Object.assign(messages['zh-TW'].guide, {
  services: { title: '古蹟講解，兩種方式讀懂希臘', offlineTitle: '線下陪同講解', offlineDesc: '提交意向日期與路線，由顧問確認線下陪同安排。', offlineCta: '填寫日期，預約陪同', liveTitle: '線上即時直播', liveDesc: '到達景點後以手機與顧問即時連線，提交預約後確認安排。', liveCta: '預約線上直播', trialTitle: '名導景點講解試聽', trialDesc: '先免費試聽，再進入深度景點講解。', trialCta: '免費試聽更多內容' }
});
Object.assign(messages.en.guide, {
  services: { title: 'Two ways to understand Greece', offlineTitle: 'In-person accompaniment', offlineDesc: 'Send a preferred date and route; a consultant confirms the in-person arrangements.', offlineCta: 'Choose a date', liveTitle: 'Live online session', liveDesc: 'Connect with a consultant while visiting the sight. Submit a request to confirm arrangements.', liveCta: 'Book a live session', trialTitle: 'Guide audio preview', trialDesc: 'Start with a free preview, then explore the deep sight guides.', trialCta: 'Try the free preview' }
});
...
Object.assign(messages['zh-CN'].liveBooking, { contactTitle: '也可以直接联系顾问', contactDesc: '提交预约或通过微信、电话确认直播时间。', call: '拨打电话', serviceTitle: '线上直播服务说明', serviceScene: '客人自行到达景点，用手机摄像头拍摄现场；Richard 通过远程视频通话实时讲解。', serviceConfirm: '提交预约后，确认预约时间、景点和联系方式，顾问再与您确认直播安排。', serviceContact: '可填写表单预约，也可复制微信号或拨打电话直接联系顾问。', serviceNotice: '线上直播需要提前预约，最终时间以顾问确认结果为准；不承诺即时接通或无预约服务。' });
Object.assign(messages['zh-TW'].liveBooking, { contactTitle: '也可以直接聯絡顧問', contactDesc: '提交預約或透過微信、電話確認直播時間。', call: '撥打電話', serviceTitle: '線上直播服務說明', serviceScene: '客人自行抵達景點，用手機鏡頭拍攝現場；Richard 透過遠程視訊通話即時講解。', serviceConfirm: '提交預約後，確認預約時間、景點和聯絡方式，顧問再與您確認直播安排。', serviceContact: '可填寫表單預約，也可複製微信號或撥打電話直接聯絡顧問。', serviceNotice: '線上直播需要提前預約，最終時間以顧問確認結果為準；不承諾即時接通或無預約服務。' });
Object.assign(messages.en.liveBooking, { contactTitle: 'Contact the consultant directly', contactDesc: 'Submit a request or confirm the session by WeChat or phone.', call: 'Call consultant', serviceTitle: 'How the live session works', serviceScene: 'You visit the sight and film it with your phone while Richard explains it live through a remote video call.', serviceConfirm: 'After you submit a request, the consultant confirms the time, sight and contact details with you before arranging the session.', serviceContact: 'Use the form to request a session, or copy the WeChat ID / call the consultant directly.', serviceNotice: 'Live sessions require advance booking. The final time is confirmed by the consultant; instant connection and walk-in service are not guaranteed.' });
...
// 0924 音频与参观流程的三个语言版本；不将视频会员描述套用于新音频。
const heritageTranslations = {
  'zh-CN': { sights: '景点讲解', history: '希腊文史', libraryIntro: '查看景点参观信息与真实音频节目', sightsIntro: '查找景点、阅读参观指南，有音频时可试听并按实际权益解锁。', albumsIntro: '按专辑浏览已发布的希腊文史节目。', searchSights: '搜索景点、城市或关键词', searchAlbums: '搜索专辑或节目', allCities: '全部城市', visitorAndPreview: '查看参观信息与试听', episodes: '集节目', minutes: '分钟', noAlbums: '暂无已发布的希腊文史专辑', noSights: '暂无可展示的景点', noPreviews: '暂无已发布的景点试听', offlineNotice: '网络异常，正在显示离线景点资料；音频节目不可用。', networkFailed: '内容加载失败，请稍后重试', retry: '重试', visitor: '参观指南', updatePending: '信息待更新，请以景点官方公告为准', source: '资料来源', verifiedAt: '最近核对', officialNotice: '参观信息可能变化，出行前请查看官方公告', map: '景点地图', mapFailed: '地图暂不可打开', highlights: '必看亮点', audioHow: '如何使用语音导览', routeStep: '路线导览：按后台维护的点位顺序依次浏览。', onlineStep: '线上游览：在手机上按点位了解景点。', expertStep: '名导讲解：收听已发布的专题讲解。', previewStep: '点按节目试听；需要完整内容时按该音频的实际权限解锁。', routes: '路线导览', noRoutes: '暂无已发布的路线或点位', online: '线上游览', expert: '名导讲解', preview: '试听', previewEnded: '试听已结束（最多60秒）', noAudio: '此处暂无可播放音频', play: '播放', pause: '暂停', full: '播放完整内容', unlockRequired: '完整音频需要相应权益', previewOnly: '当前仅提供试听，暂未配置单独解锁方式', unavailable: '音频已下架或暂不可用', album: '专辑', program: '节目', duration: '时长', requestDateNotice: '请选择期望日期；可预约时间以顾问确认结果为准，日历不代表实时排班。', bookingFormTitle: '告诉顾问你的需求', submitBookingNote: '提交后由顾问确认时间与安排', reserve: '预约线下陪同', bookingSubmittedDesc: '顾问将联系您确认时间与服务安排。', durationOptions: ['半日陪同', '1日陪同', '多日陪同'], peopleOptions: ['1-2位成人', '3-5位成人', '6位以上']  },
  'zh-TW': { sights: '景點講解', history: '希臘文史', libraryIntro: '查看景點參觀資訊與真實音頻節目', sightsIntro: '查找景點、閱讀參觀指南，有音頻時可試聽並依實際權益解鎖。', albumsIntro: '按專輯瀏覽已發布的希臘文史節目。', searchSights: '搜尋景點、城市或關鍵字', searchAlbums: '搜尋專輯或節目', allCities: '全部城市', visitorAndPreview: '查看參觀資訊與試聽', episodes: '集節目', minutes: '分鐘', noAlbums: '暫無已發布的希臘文史專輯', noSights: '暫無可展示的景點', noPreviews: '暫無已發布的景點試聽', offlineNotice: '網路異常，正在顯示離線景點資料；音頻節目不可用。', networkFailed: '內容載入失敗，請稍後重試', retry: '重試', visitor: '參觀指南', updatePending: '資訊待更新，請以景點官方公告為準', source: '資料來源', verifiedAt: '最近核對', officialNotice: '參觀資訊可能變動，出行前請查看官方公告', map: '景點地圖', mapFailed: '地圖暫時無法開啟', highlights: '必看亮點', audioHow: '如何使用語音導覽', routeStep: '路線導覽：按後台維護的點位順序依次瀏覽。', onlineStep: '線上遊覽：在手機上按點位了解景點。', expertStep: '名導講解：收聽已發布的專題講解。', previewStep: '點按節目試聽；完整內容按該音頻的實際權限解鎖。', routes: '路線導覽', noRoutes: '暫無已發布的路線或點位', online: '線上遊覽', expert: '名導講解', preview: '試聽', previewEnded: '試聽已結束（最多60秒）', noAudio: '目前沒有可播放音頻', play: '播放', pause: '暫停', full: '播放完整內容', unlockRequired: '完整音頻需要相應權益', previewOnly: '目前僅提供試聽，暫未配置單獨解鎖方式', unavailable: '音頻已下架或暫不可用', album: '專輯', program: '節目', duration: '時長', requestDateNotice: '請選擇期望日期；可預約時間以顧問確認為準，日曆並非即時排班。', bookingFormTitle: '告訴顧問你的需求', submitBookingNote: '提交後由顧問確認時間與安排', reserve: '預約線下陪同', bookingSubmittedDesc: '顧問將聯絡您確認時間與服務安排。', durationOptions: ['半日陪同', '1日陪同', '多日陪同'], peopleOptions: ['1-2位成人', '3-5位成人', '6位以上']  },
  en: { sights: 'Sight guides', history: 'Greek history & culture', libraryIntro: 'Practical sight information and published audio programmes', sightsIntro: 'Find a sight, read visiting tips and preview audio when it is available. Full access depends on each recording.', albumsIntro: 'Browse published Greek history and culture programmes by album.', searchSights: 'Search sights, cities or topics', searchAlbums: 'Search albums or episodes', allCities: 'All cities', visitorAndPreview: 'Visit info and audio preview', episodes: 'episodes', minutes: 'min', noAlbums: 'No published albums yet', noSights: 'No sights available', noPreviews: 'No published audio previews yet', offlineNotice: 'Network unavailable. Showing offline sight information; audio is unavailable.', networkFailed: 'Content could not load. Try again later.', retry: 'Retry', visitor: 'Visitor guide', updatePending: 'Information pending; consult the official site', source: 'Source', verifiedAt: 'Last checked', officialNotice: 'Visiting details may change. Check the official site before you go.', map: 'Sight map', mapFailed: 'Map could not be opened', highlights: 'Must-see highlights', audioHow: 'How to use the audio guide', routeStep: 'Route: follow the published point order.', onlineStep: 'Online visit: explore individual points on your phone.', expertStep: 'Expert guide: listen to published talks.', previewStep: 'Preview a recording; full access follows its own rights.', routes: 'Route guide', noRoutes: 'No published route or points yet', online: 'Online visit', expert: 'Expert talk', preview: 'Preview', previewEnded: 'Preview ended (60 seconds max)', noAudio: 'No audio available here', play: 'Play', pause: 'Pause', full: 'Play full recording', unlockRequired: 'Full audio requires the relevant access', previewOnly: 'Preview only; no separate unlock option is configured.', unavailable: 'Recording is offline or unavailable', album: 'Album', program: 'Episode', duration: 'Duration', requestDateNotice: 'Choose a preferred date. Availability is confirmed by a consultant; this is not a live schedule.', bookingFormTitle: 'Tell a consultant what you need', submitBookingNote: 'A consultant will confirm availability after you submit', reserve: 'Request in-person guidance', bookingSubmittedDesc: 'A consultant will contact you to confirm the time and arrangements.', durationOptions: ['Half day', 'Full day', 'Multiple days'], peopleOptions: ['1–2 adults', '3–5 adults', '6+ travelers'] }
};
Object.keys(heritageTranslations).forEach((locale) => { messages[locale].heritage = heritageTranslations[locale]; });
Object.assign(messages['zh-CN'].guide, { bookingTitle: '提交线下陪同意向', bookingSub: '请选择期望日期并填写需求，具体时间由顾问确认，日历并非实时排班。', calendarNote: '请选择期望日期', chooseDate: '请选择期望日期', closingCopy: '提交预约后，顾问将进一步确认服务安排。', bottomBar: '线下陪同 · 预约咨询' });
