...
Object.assign(messages['zh-CN'], {
  productHome: { searchPlaceholder: '搜索景点或人文关键词', popular: '热门景点讲解', freeTrial: '免费试看', liveTitle: '线上文史直播讲解', liveDesc: '与顾问预约一场有温度的现场导览', reserve: '立即预约', memberTitle: '终身会员', memberDesc: '解锁全部景点视频讲解，后续上新免费', openMember: '开通终身会员', categories: ['雅典区域', '圣托里尼', '克里特', '伯罗奔尼撒', '扎金索斯', '其他古迹'], banners: ['终身会员特惠', '热门景点讲解', '直播预约入口'] },
  paidContent: { video: '景点视频讲解', trial: '试看', trialUnavailable: '后台尚未配置试看时长', trialEnded: '试看已结束', trialEndedDesc: '选择一种方式解锁完整讲解', buySpot: '购买本景点单篇讲解', buySpotDesc: '一次性付费 · 永久观看本景点', member: '开通终身会员', memberDesc: '全部景点 · 后续上新免费', payUnavailable: '支付服务尚未配置，请稍后再试', unlock: '解锁完整讲解', related: '同区域其他讲解', appointment: '预约直播讲解', freeText: '图文知识库 · 全部免费看', memberUnlocked: '终身会员 · 已解锁', purchased: '已购 · 永久观看', trialConfigured: '试看 {seconds} 秒', simulationTitle: '模拟订单（仅测试环境）', simulationSuccess: '模拟支付成功', simulationFailure: '模拟支付失败' },
...
Object.assign(messages['zh-TW'], {
  productHome: { searchPlaceholder: '搜尋景點或人文關鍵詞', popular: '熱門景點講解', freeTrial: '免費試看', liveTitle: '線上文史直播講解', liveDesc: '與顧問預約一場有溫度的現場導覽', reserve: '立即預約', memberTitle: '終身會員', memberDesc: '解鎖全部景點影片講解，後續上新免費', openMember: '開通終身會員', categories: ['雅典區域', '聖托里尼', '克里特', '伯羅奔尼撒', '扎金索斯', '其他古蹟'], banners: ['終身會員特惠', '熱門景點講解', '直播預約入口'] },
  paidContent: { video: '景點影片講解', trial: '試看', trialUnavailable: '後台尚未配置試看時長', trialEnded: '試看已結束', trialEndedDesc: '選擇一種方式解鎖完整講解', buySpot: '購買本景點單篇講解', buySpotDesc: '一次性付費 · 永久觀看本景點', member: '開通終身會員', memberDesc: '全部景點 · 後續上新免費', payUnavailable: '支付服務尚未配置，請稍後再試', unlock: '解鎖完整講解', related: '同區域其他講解', appointment: '預約直播講解', freeText: '圖文知識庫 · 全部免費看', memberUnlocked: '終身會員 · 已解鎖', purchased: '已購 · 永久觀看', trialConfigured: '試看 {seconds} 秒', simulationTitle: '模擬訂單（僅測試環境）', simulationSuccess: '模擬支付成功', simulationFailure: '模擬支付失敗' },
...
Object.assign(messages.en, {
  productHome: { searchPlaceholder: 'Search sights or cultural topics', popular: 'Popular guided sights', freeTrial: 'Free preview', liveTitle: 'Live humanities session', liveDesc: 'Reserve a warm, personal session with a consultant', reserve: 'Reserve now', memberTitle: 'Lifetime membership', memberDesc: 'Unlock every sight video, including future releases', openMember: 'Join lifetime', categories: ['Athens', 'Santorini', 'Crete', 'Peloponnese', 'Zakynthos', 'Other heritage'], banners: ['Lifetime membership', 'Popular guided sights', 'Live booking'] },
  paidContent: { video: 'Video guide', trial: 'Preview', trialUnavailable: 'Trial duration is not configured by the backend', trialEnded: 'Preview ended', trialEndedDesc: 'Choose an option to unlock the full guide', buySpot: 'Buy this sight', buySpotDesc: 'One-time payment · Permanent access', member: 'Join lifetime membership', memberDesc: 'All sights · Future releases included', payUnavailable: 'Payment is not configured yet. Please try again later.', unlock: 'Unlock full guide', related: 'More guides nearby', appointment: 'Book a live session', freeText: 'Text knowledge base · Free for everyone', memberUnlocked: 'Lifetime member · Unlocked', purchased: 'Purchased · Permanent access', trialConfigured: '{seconds}s preview', simulationTitle: 'Simulated order (test only)', simulationSuccess: 'Simulate payment success', simulationFailure: 'Simulate payment failure' },
