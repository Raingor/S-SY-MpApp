...
Object.assign(messages['zh-TW'], {
  ...
  paidContent: { video: '景點影片講解', trial: '試看', trialUnavailable: '後台尚未配置試看時長', trialEnded: '試看已結束', trialEndedDesc: '選擇一種方式解鎖完整講解', buySpot: '購買本景點單篇講解', buySpotDesc: '一次性付費 · 永久觀看本景點', member: '開通終身會員', memberDesc: '全部景點 · 後續上新免費', payUnavailable: '支付服務尚未配置，請稍後再試', unlock: '解鎖完整講解', related: '同區域其他講解', appointment: '預約直播講解', freeText: '圖文知識庫 · 全部免費看', memberUnlocked: '終身會員 · 已解鎖', purchased: '已購 · 永久觀看', trialConfigured: '試看 {seconds} 秒', simulationTitle: '模擬訂單（僅測試環境）', simulationSuccess: '模擬支付成功', simulationFailure: '模擬支付失敗', simulationLoginTitle: '用測試手機號查看購買記錄', simulationLoginDesc: '輸入測試手機號建立模擬身份，訂單和課程權益將按手機號隔離保存。', simulationPhonePlaceholder: '請輸入測試手機號', simulationLogin: '進入支付測試', simulationLoginFailed: '測試身份建立失敗', simulationLoginSuccess: '已進入支付測試', purchasedCourses: '已購買課程', paymentOrders: '支付訂單' },
