...
Object.assign(messages['zh-CN'], {
  homeSlogan: '只为一生美好回忆', homeGuideCta: '查看档案 / 预约时间', selectedRoutes: '甄选路线', viewAllRoutes: '查看全部参考行程', viewReference: '查看参考行程', customItinerary: '定制行程 · 填写需求，获取专属方案', customItineraryDesc: '以上路线仅作参考，告诉我们你的日期、人数与偏好，顾问一对一为你定制专属行程', luxury: '奢享体验', luxuryTag: '高端定制', luxuryCta: '定制咨询', destinations: '精选目的地', civilization: '文明溯源', islands: '海岛度假'
});
Object.assign(messages['zh-TW'], {
  homeSlogan: '只為一生美好回憶', homeGuideCta: '查看檔案 / 預約時間', selectedRoutes: '精選路線', viewAllRoutes: '查看全部參考行程', viewReference: '查看參考行程', customItinerary: '定製行程 · 填寫需求，獲取專屬方案', customItineraryDesc: '以上路線僅作參考，告訴我們你的日期、人數與偏好，顧問一對一為你定製專屬行程', luxury: '奢享體驗', luxuryTag: '高端定製', luxuryCta: '定製諮詢', destinations: '精選目的地', civilization: '文明溯源', islands: '海島度假'
});
Object.assign(messages.en, {
  homeSlogan: 'Only for a lifetime of beautiful memories', homeGuideCta: 'View profile / Reserve time', selectedRoutes: 'Selected routes', viewAllRoutes: 'View all reference trips', viewReference: 'View itinerary', customItinerary: 'Private itinerary · Share your needs for a tailored plan', customItineraryDesc: 'Routes are examples. Tell us your dates, group and preferences for one-to-one planning.', luxury: 'Luxury experiences', luxuryTag: 'Bespoke luxury', luxuryCta: 'Request a plan', destinations: 'Featured destinations', civilization: 'Heritage', islands: 'Island escapes'
});
...
messages['zh-CN'].knowledgePage = { title: '希腊景点', subtitle: '从卫城到梅黛奥拉，把每一次参访变成真正看懂的现场。选择一座城市，开启导览讲解。', pill1: '城市导览', pill2: '必看亮点', pill3: '参观指南', pill4: '深度讲解', cities: '精选城市', trips: '包含这些景点的行程', consultTitle: '想把景点读得更深？', consultDesc: '预约一对一线上人文咨询，先聊聊你的目的地。', viewTrips: '查看全部参考行程' };
messages['zh-TW'].knowledgePage = { title: '希臘景點', subtitle: '從衛城到梅黛奧拉，把每一次參訪變成真正看懂的現場。選擇一座城市，開啟導覽講解。', pill1: '城市導覽', pill2: '必看亮點', pill3: '參觀指南', pill4: '深度講解', cities: '精選城市', trips: '包含這些景點的行程', consultTitle: '想把景點讀得更深？', consultDesc: '預約一對一線上人文諮詢，先聊聊你的目的地。', viewTrips: '查看全部參考行程' };
messages.en.knowledgePage = { title: 'Greek sights', subtitle: 'From the Acropolis to Meteora, turn every visit into a place you truly understand. Choose a city to begin.', pill1: 'City guides', pill2: 'Highlights', pill3: 'Visitor guide', pill4: 'Deep dive', cities: 'Featured cities', trips: 'Trips featuring these sights', consultTitle: 'Want to go deeper?', consultDesc: 'Book a one-to-one humanities consultation and start with your destination.', viewTrips: 'View all reference trips' };
...
messages['zh-CN'].profileDetail = { orders: '我的预约', trips: '我的行程', coupons: '优惠券', travelers: '常用出行人', visa: '护照签证资料', noOrders: '还没有提交过预约或咨询', noTrips: '暂未安排导游陪同行程', noCoupons: '当前没有可使用的优惠券', noTravelers: '添加常用出行人，填写表单时更方便', noVisa: '添加资料后可在预约时快速查看', emptyDesc: '提交咨询后，顾问确认的进度会显示在这里', addTraveler: '添加出行人', addDocument: '添加资料', edit: '编辑', delete: '删除' };
messages['zh-TW'].profileDetail = { orders: '我的預約', trips: '我的行程', coupons: '優惠券', travelers: '常用出行人', visa: '護照簽證資料', noOrders: '還沒有提交過預約或諮詢', noTrips: '暫未安排導遊陪同行程', noCoupons: '目前沒有可使用的優惠券', noTravelers: '添加常用出行人，填寫表單時更方便', noVisa: '添加資料後可在預約時快速查看', emptyDesc: '提交諮詢後，顧問確認的進度會顯示在這裡', addTraveler: '添加出行人', addDocument: '添加資料', edit: '編輯', delete: '刪除' };
messages.en.profileDetail = { orders: 'My bookings', trips: 'My trips', coupons: 'Coupons', travelers: 'Travelers', visa: 'Passport & visa', noOrders: 'No bookings or inquiries yet', noTrips: 'No guided trip arranged yet', noCoupons: 'No coupons available', noTravelers: 'Add a traveler to make future forms easier', noVisa: 'Add a document to review it quickly when booking', emptyDesc: 'Progress confirmed by a consultant will appear here', addTraveler: 'Add traveler', addDocument: 'Add document', edit: 'Edit', delete: 'Delete' };
...
messages['zh-CN'].contentPage = { about: '景点概览', highlights: '必看亮点', allHighlights: '查看全部', collapseHighlights: '收起亮点', visitorGuide: '参观指南', deepDive: '深度文史讲解', freePreview: '免费文字预览', paid: '付费解锁内容', locked: '锁定', unlock: '付费解锁（功能开发中）', consultTitle: '想把景点读得更深？', consultDesc: '预约一对一线上人文咨询，先聊聊你的目的地。', cityAbout: '了解「SY希旅人」导览讲解的不同之处', cityInside: '专业编写的图文与语音讲解，按景点逐层展开：先看必看亮点，再看参观指南，最后深入历史、神话与建筑。', buy: '购买导览包', viewSpots: '先看景点', freeBrowse: '免费浏览', buySpots: '购买', itineraryPeriod: '行程日期', itineraryNumber: '订单编号', visitors: '旅客人数', preferredLanguages: '语种需求', plannedVehicle: '计划车型', privateGuide: '推荐司导', invalidItinerary: '未找到该行程', invalidLink: '行程链接无效或已失效' };
messages['zh-TW'].contentPage = { about: '景點概覽', highlights: '必看亮點', allHighlights: '查看全部', collapseHighlights: '收起亮點', visitorGuide: '參觀指南', deepDive: '深度文史講解', freePreview: '免費文字預覽', paid: '付費解鎖內容', locked: '鎖定', unlock: '付費解鎖（功能開發中）', consultTitle: '想把景點讀得更深？', consultDesc: '預約一對一線上人文諮詢，先聊聊你的目的地。', cityAbout: '了解「SY希旅人」導覽講解的不同之處', cityInside: '專業編寫的圖文與語音講解，按景點逐層展開：先看必看亮點，再看參觀指南，最後深入歷史、神話與建築。', buy: '購買導覽包', viewSpots: '先看景點', freeBrowse: '免費瀏覽', buySpots: '購買', itineraryPeriod: '行程日期', itineraryNumber: '訂單編號', visitors: '旅客人數', preferredLanguages: '語種需求', plannedVehicle: '計劃車型', privateGuide: '推薦司導', invalidItinerary: '未找到該行程', invalidLink: '行程連結無效或已失效' };
messages.en.contentPage = { about: 'Overview', highlights: 'Highlights', allHighlights: 'View all', collapseHighlights: 'Show less', visitorGuide: 'Visitor guide', deepDive: 'History & context', freePreview: 'Free text preview', paid: 'Paid content', locked: 'Locked', unlock: 'Unlock (coming soon)', consultTitle: 'Want to go deeper?', consultDesc: 'Book a one-to-one humanities consultation and start with your destination.', cityAbout: 'What makes SY Traveler guides different', cityInside: 'Professionally written text and audio guides unfold by sight: highlights first, then practical visiting notes, then history, mythology and architecture.', buy: 'Buy guide package', viewSpots: 'Browse sights', freeBrowse: 'Free preview', buySpots: 'Buy', itineraryPeriod: 'Travel dates', itineraryNumber: 'Itinerary number', visitors: 'Travelers', preferredLanguages: 'Languages', plannedVehicle: 'Vehicle', privateGuide: 'Private guide', invalidItinerary: 'Itinerary not found', invalidLink: 'This itinerary link is invalid or expired' };
...
Object.assign(messages['zh-CN'].profile, { loginFailed: '微信登录失败', avatarUploadFailed: '头像上传失败', phoneAuthRequired: '需要授权手机号后才能修改', phoneBindFailed: '绑定失败', nicknameRequired: '请输入昵称', nicknameInvalid: '请使用其他昵称', saveFailed: '保存失败', aboutTitle: '关于 SY 希旅人', copyWebsite: '复制官网', close: '关闭', websiteCopied: '官网已复制', profileIntro: '用于展示您的微信昵称和头像' });
Object.assign(messages['zh-TW'].profile, { loginFailed: '微信登入失敗', avatarUploadFailed: '頭像上傳失敗', phoneAuthRequired: '需要授權手機號後才能修改', phoneBindFailed: '綁定失敗', nicknameRequired: '請輸入暱稱', nicknameInvalid: '請使用其他暱稱', saveFailed: '保存失敗', aboutTitle: '關於 SY 希旅人', copyWebsite: '複製官網', close: '關閉', websiteCopied: '官網已複製', profileIntro: '用於展示您的微信暱稱和頭像' });
Object.assign(messages.en.profile, { loginFailed: 'WeChat sign-in failed', avatarUploadFailed: 'Avatar upload failed', phoneAuthRequired: 'Phone authorization is required before editing', phoneBindFailed: 'Phone linking failed', nicknameRequired: 'Please enter a name', nicknameInvalid: 'Please choose another name', saveFailed: 'Save failed', aboutTitle: 'About SY Traveler', copyWebsite: 'Copy website', close: 'Close', websiteCopied: 'Website copied', profileIntro: 'Used to display your WeChat name and avatar' });
