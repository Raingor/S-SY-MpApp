...
const themes = {
  'zh-CN': [
    ...
    { key: 'dining', label: '餐厅偏好', options: ['音乐会等演出', '山顶夜景餐厅', '卫城夜景餐厅', '传统演艺餐厅', '海湾浪漫餐厅', '湖畔露天餐厅', '米其林餐厅'] },
    ...
    { key: 'luxury', label: '高端私旅', options: ['高级游艇', '豪华游艇', '超级游艇', '私人飞机'] },
    { key: 'business', label: '商务服务', options: ['投资考察', '合作对接', '会务策划'] },
    { key: 'driver', label: '司导服务', options: ['全程包车服务', '专业讲解'] },
  ...
  'zh-TW': [
    ...
    { key: 'dining', label: '餐廳偏好', options: ['音樂會等演出', '山頂夜景餐廳', '衛城夜景餐廳', '傳統演藝餐廳', '海灣浪漫餐廳', '湖畔露天餐廳', '米其林餐廳'] },
    ...
    { key: 'luxury', label: '高端私旅', options: ['高級遊艇', '豪華遊艇', '超級遊艇', '私人飛機'] },
    { key: 'business', label: '商務服務', options: ['投資考察', '合作對接', '會務策劃'] },
    { key: 'driver', label: '司導服務', options: ['全程包車服務', '專業講解'] },
